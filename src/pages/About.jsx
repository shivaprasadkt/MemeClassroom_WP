...
const About = () => {
  ...
  const glassPanelClass = highContrastMode
    ...
    : "glass-panel bg-white/50 dark:bg-gray-900/60 backdrop-blur-md border border-gray-200/50 dark:border-gray-800/40 p-6 rounded-2xl shadow-xl hover:translate-y-[-2px] transition-all duration-200";

  const darkPaneClass = highContrastMode
    ? "bg-black border-2 border-yellow-400 text-yellow-400 p-8 rounded-none mt-12"
    : "bg-gray-900 dark:bg-gray-950/90 text-gray-100 border border-transparent p-8 rounded-2xl shadow-2xl mt-12 transition-all";
  ...
  const bannerClass = highContrastMode
    ...
    : "bg-gradient-to-r from-purple-900/60 to-indigo-900/60 backdrop-blur border border-purple-500/20 text-white p-6 rounded-2xl shadow-lg col-span-1 md:col-span-2";

  return (
    <div className="max-w-5xl mx-auto py-8 px-4 space-y-10">
      {/* 1. Intro Header block */}
      <div className="text-center space-y-4">
        <span className="bg-purple-100 dark:bg-purple-950/40 text-purple-750 dark:text-purple-300 text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full">
          Pedagogy & Design
        </span>
        ...
        {/* Quote Box */}
        <div className={`max-w-3xl mx-auto mt-6 text-left border-l-4 ${highContrastMode ? 'border-yellow-400 bg-black text-yellow-400' : 'border-purple-500 bg-purple-50/30 dark:bg-purple-950/10'} p-5 italic rounded-r-xl text-sm leading-relaxed`}>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className={glassPanelClass}>
            ...
            <h3 className="font-extrabold text-base mb-1">Meme Lab (Creation)</h3>
          ...
          <div className={glassPanelClass}>
            <div className="text-2xl mb-2">📚</div>
            <h3 className="font-extrabold text-base mb-1">Meme Library (Curation)</h3>
          ...
          <div className={glassPanelClass}>
            <div className="text-2xl mb-2">🏫</div>
            <h3 className="font-extrabold text-base mb-1">Staffroom (Collaboration)</h3>
            <p className="text-xs text-gray-500 dark:text-gray-455 leading-relaxed">
          ...
          <div className={glassPanelClass}>
            <div className="text-2xl mb-2">📄</div>
            <h3 className="font-extrabold text-base mb-1">Meme Reads (Scaffolding)</h3>
            <p className="text-xs text-gray-500 dark:text-gray-455 leading-relaxed">
      ...
      <div className={darkPaneClass}>
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
            <div className={`p-5 rounded-xl border ${highContrastMode ? 'border-yellow-400 bg-black text-yellow-400' : 'border-gray-800 bg-gray-950/40 text-gray-250'} space-y-2`}>
            ...
            <div className={`p-5 rounded-xl border ${highContrastMode ? 'border-yellow-400 bg-black text-yellow-400' : 'border-gray-800 bg-gray-950/40 text-gray-250'} space-y-2`}>
              ...
              <p className="text-[11px] text-gray-455 leading-relaxed">
